...
description: "Run a decision through 5 AI advisors who debate independently, peer-review anonymously, then synthesize a verdict. Triggers: 'council this', 'run the council', 'pressure-test this', 'should I X or Y'."
